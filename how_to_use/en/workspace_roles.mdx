...
<Note>
**Workspace Members vs. Developers with PR Review Access**: These are separate concepts.

- **Workspace Members**: Admins who configure Kodus settings (unlimited)
- **Developers with Review Access**: Developers in your Git org who get Kody reviews on their PRs (based on your plan)
