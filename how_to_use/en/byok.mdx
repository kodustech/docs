...
<Card
  title="See Teams Pricing"
  icon="scale-balanced"
  href="/how_to_use/en/pricing#teams-pricing"
>
  BYOK is the billing model available on the Teams plan at $10/dev/month.
</Card>
...
<AccordionGroup>
  ...
  <Accordion title="Is BYOK the billing model for Teams?">
    Yes. The Teams plan uses **BYOK ($10/dev/month)**, so you manage API keys and token usage directly with your provider.
  </Accordion>
