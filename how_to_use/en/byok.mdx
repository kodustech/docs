...
BYOK (Bring Your Own Key) is the **default way Kodus uses LLMs across every plan** — Community, Teams, and Enterprise. You connect your own provider account, choose any model, pay only for what you use, and monitor costs directly on your provider's dashboard. Kodus never marks up tokens.
