...
3. Large PRs: Very large PRs or PRs touching a high number of files can take longer or be skipped. As a guideline, PRs with more than 200 files are not reviewed. See limits in Pricing.
