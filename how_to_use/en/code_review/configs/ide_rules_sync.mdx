---
title: "IDE Rules Sync"
description: "Automatically sync and import your existing IDE configuration files to enhance Kody's code review capabilities with your team's established coding standards."
---
...
## What is IDE Rules Sync?

IDE Rules Sync automatically detects and imports configuration files from popular AI coding assistants and IDEs in your repository. This ensures Kody understands and respects your existing coding standards without requiring manual setup.

## Supported IDE Rule Files

Kodus automatically detects and syncs the following rule file patterns:
