...
<Tabs>
  ...
  <Tab title="Memories">
    Persistent contextual instructions that are injected across all prompts and conversations. Memories allow Kody to learn and retain your team's coding conventions, preferences, and architectural decisions.
