...
<Columns cols={2}>
  <Card title="Sync your existing IDE rules to Kody" icon="panel-left-close" href="/how_to_use/en/code_review/configs/rules_file_detection">
  ...
  <Card title="Generate Kody Rules from your past reviews" icon="panel-right-close" href="/how_to_use/en/code_review/learning/kody_rules_generation">
    Kodus can automatically generate Kody Rules from your past reviews.
  </Card>
</Columns>
