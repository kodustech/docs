...
<Tabs>
  ...
  <Tab title="Memórias">
    Instruções contextuais persistentes que são injetadas em todos os prompts e conversas. As Memórias permitem que Kody aprenda e retenha as convenções de codificação, preferências e decisões arquiteturais da sua equipe.
