...
## Next Steps
<CardGroup cols={2}>
  <Card title="Run Kodus API Locally" icon="laptop" href="/how_to_deploy/en/local_quickstart/orchestrator">
    Ideal for local development and getting familiar with the API stack.
  </Card>
