...
- ✅ **Services**: Kodus API, PostgreSQL, MongoDB
...
3. **Test webhook endpoints**: Your Git provider webhooks should point to `http://localhost:3332/[provider]/webhook` (or to your API domain if a reverse proxy routes `/.../webhook` to the webhooks service)
