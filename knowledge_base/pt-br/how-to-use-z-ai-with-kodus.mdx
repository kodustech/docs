...
<Note>
  Seu JSON deve estar envolvido sob o namespace `openaiCompatible` porque esse é o provedor ativo. Veja a [documentação principal de BYOK → Sobrescrita por JSON customizado](/how_to_use/pt-br/byok#custom-json-override) para as regras completas de namespace.
</Note>
