...
Veja a lista completa e preços atuais em [llm.chutes.ai/v1/models](https://llm.chutes.ai/v1/models).
...
3. Preencha os campos:
   ...
   | **Chave de API** | sua chave de API do Chutes |
   | **URL Base** | `https://llm.chutes.ai/v1` |
   | **Modelo** | ex.: `deepseek-ai/DeepSeek-V3-0324-TEE` |
   | **Máx. de Requisições Simultâneas** | `3–5` é um bom ponto de partida; aumente se não atingir o limite |
