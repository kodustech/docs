...
<Note>
  Tu JSON debe estar envuelto bajo el namespace `openaiCompatible` porque ese es el proveedor activo. Consulta la [documentación principal de BYOK → Sobrescritura con JSON personalizado](/how_to_use/es/byok#custom-json-override) para las reglas completas de namespace.
</Note>
