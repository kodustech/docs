...
<Note>
  Your JSON must be wrapped under the `openaiCompatible` namespace because that's the active provider. See the [main BYOK doc → Custom JSON override](/how_to_use/en/byok#custom-json-override) for the full namespace rules.
</Note>
